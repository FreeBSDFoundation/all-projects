...
| Project Goals | **Primary Goal**  The goal of the project is to ensure that the FreeBSD Foundation, the Project, and the Community are aware of, and actively engaged in, preparing for the CRA so that: The Foundation meets its legal obligations as an OSS project steward. The Project can benefit from any new opportunities to receive support from manufacturers. The Project is protected from disruption by manufacturers seeking to meet CRA regulations. The Community does not experience any reduction in contributions caused by contributors mistakenly thinking they have a legal liability under the CRA.  **Goal limitations**  Based on current funding, we propose to limit the following goals to only what is essential for achieving the primary goals above: Delivering CRA educational activities for the community. Actively engaging with upstream/downstream OSS projects. Engaging in EU policy development.  Gathering quantitative information about effectiveness of work done.  |
| Outcomes | 8 key outcomes fall into 3 categories: **Foundation readiness** Compliance as a steward. Financial/material support from manufacturers. **Project readiness** Clear understanding of potential types of critical CRA-related scenarios. Updated processes and staffing required to cope with above scenarios. A functional SBOM toolchain. **Community readiness** A documented guide to the CRA and how it affects the FreeBSD Project and contributors. A mechanism for FreeBSD community engagement in EU policymaking. A public record of work the Foundation is doing on CRA readiness. |

# A note on the scope of the project

The CRA is a new piece of legislation and the real-world implementation, best practice, and other implications are constantly evolving. Therefore, you should expect to see the scope of this project adapt over time as our understanding develops.
