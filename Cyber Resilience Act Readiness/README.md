...
| Outcomes | 8 key outcomes fall into 3 categories: <br/><br/>**Foundation readiness** <br/> - Compliance as a steward. <br/> - Financial/material support from manufacturers.<br/><br/> **Project readiness** <br/> - Clear understanding of potential types of critical CRA-related scenarios. <br/> - Updated processes and staffing required to cope with above scenarios. <br/> - A functional SBOM toolchain. <br/><br/>**Community readiness** <br/> - A documented guide to the CRA and how it affects the FreeBSD Project and contributors. <br/> - A mechanism for FreeBSD community engagement in EU policymaking. <br/> - A public record of work the Foundation is doing on CRA readiness. |
